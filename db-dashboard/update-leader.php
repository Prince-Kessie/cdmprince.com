...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (!isset($_GET["id"])) {
        header("location:\cdm-tem\db-dashboard\index.php");
        exit;
    }
    ...
    $sql = "SELECT * FROM cdm_leadership where id=$id";
    ...
    do {
        if (empty($id) || empty($fullname) || empty($email) || empty($contact) || empty($role) || empty($address)) {
            $errorMessage = "All the fields are required";
            break;
        }

        $sql = "UPDATE cdm_leadership SET fullname ='$fullname', email = '$email', contact = '$contact', 
       role = '$role',  address = '$address' WHERE id = $id";
...
<body class="bg-theme bg-theme1">
    ...
    <div id="wrapper">
        ...
        <div class="container" style="margin-top: 90px;">
            ...
            <h2 class="text-center">Add Leadership</h2>
            ...
            <form method="POST" style="padding-bottom: 70px">
                ...
                <div class="form-group">
                    <label>Role</label>
                    <input type="text" class="form-control" placeholder="Enter Contact" name="role"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3 d-grid cancel">
                        <a class="btn btn-outline-primary canc " role="button"
                            href="/cdm-tem/db-dashboard/index.php">Cancel</a>
                    </div>
                </div>
