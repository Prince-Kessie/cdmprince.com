...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        if (empty($fullname) || empty($email) || empty($contact) || empty($role) || empty($address)) {
        ...
        $sql = "INSERT INTO cdm_leadership (fullname, email, contact, role, address)" .
            "VALUES ('$fullname', '$email', '$contact', '$role', '$address')";
