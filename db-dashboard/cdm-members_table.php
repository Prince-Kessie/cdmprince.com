        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title text-center ">Christ's Disciples Movement Membership</h5>
                            <a class="btn btn-primary" href="\cdm-tem\db-dashboard\add-member.php" role="button">Add
                                Member</a>
                            <br>
                            <div class="table-responsive" style="margin-top: 3px;">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT * FROM cdm_membership";
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            <td>
                                                <a class='btn btn-primary btn-sm'
                                                    href='\cdm-tem\db-dashboard\update-member.php?id=$row[id]'>Update</a>
                                            </td>
                                        </tr>
                                            ";
                                        }
