    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
            ...
            <ul class="sidebar-menu do-nicescrol">
                ...
                <li>
                    <a href="admin-signin_table.php">
                        <i class="zmdi zmdi-format-list-bulleted"></i> <span>Admin Signin</span>
                        <small class="badge float-right badge-light">View</small>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="admin-delete.php">
                        <i class="fa fa-trash"></i> <span>Remove CDM Admin</span>
                    </a>
                </li>
                ...
                <ul class="navbar-nav align-items-center right-nav-link">
                    ...
                    <li class="nav-item">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
                            <span class="user-profile"><img src="../assets/admin-assets/images/chin.jpg"
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title text-center">Christ's Disciples Movement Leadership</h5>
                            <a class="btn btn-primary" href="\cdm-tem\db-dashboard\add-leader.php" role="button">Add
                                Leader</a>
                            <br>
                            <div class="table-responsive" style="margin-top: 3px;">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT * FROM cdm_leadership";
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            <td>
                                                <a class='btn btn-primary btn-sm'
                                                    href='\cdm-tem\db-dashboard\update-leader.php?id=$row[id]'>Update</a>
                                            </td>
                                        </tr>
                                            ";
                                        }
