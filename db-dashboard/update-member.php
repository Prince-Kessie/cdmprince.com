...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $sql = "SELECT * FROM cdm_membership where id=$id";
    ...
    do {
        if (empty($id) || empty($fullname) || empty($email) || empty($contact) || empty($address)) {
            $errorMessage = "All the fields are required";
            break;
        }

        $sql = "UPDATE cdm_membership SET fullname ='$fullname', email = '$email', contact = '$contact', 
