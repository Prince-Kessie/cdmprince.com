            ...
            <div class="container-fluid">
                ...
                <div class="card" style="padding-bottom: 310px;">
                    <div class="card-header">
                        <h4><span style="color: white; padding-left: 210px;">Remove Membership by ID</span></h4>
                    </div>
                    <div class="form-group col-sm-12 ">

                        <form method="POST" action="\cdm-tem\db-dashboard\member-delete.inc.php">
                            <div class="form-group">
                                <input name="userid" type="text" style="margin-left: 220px;
                              width: 250px; height: 40px; margin-top: 60px; padding-left: 26px;" placeholder="Enter Member ID" required>
