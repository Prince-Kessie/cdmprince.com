    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
            ...
            <ul class="sidebar-menu do-nicescrol">
                ...
                <li>
                    <a href="\cdm-tem\db-dashboard/client_subscribe_table.php">
                        <i class="zmdi zmdi-format-list-bulleted"></i> <span>Clients Subscribe</span>
                        <small class="badge float-right badge-light">View</small>
                    </a>
                </li>
                <li>
                    <a href="\cdm-tem\db-dashboard/client_email_footer_table.php">
                        <i class="zmdi zmdi-format-list-bulleted"></i> <span>Clients Email</span>
                        <small class="badge float-right badge-light">View</small>
                    </a>
                </li>
                <li>
                    <a href="\cdm-tem\db-dashboard/clients_reply_table.php">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="card" style="padding-bottom: 310px;">
                    <div class="card-header">
                        <h4><span style="color: white; padding-left: 210px;">Remove Leadership by ID</span></h4>
                    </div>
                    <div class="form-group col-sm-12 ">

                        <form method="POST" action="\cdm-tem\db-dashboard\leader-delete.inc.php">
                            <div class="form-group">
                                <input name="userid" type="text" style="margin-left: 220px;
                              width: 250px; height: 40px; margin-top: 60px; padding-left: 26px;" placeholder="Enter Leader ID" required>
